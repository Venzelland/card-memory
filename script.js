...
const wordsArr = {
    ...
    nature_and_weather: [{english: 'sun', russian: 'солнце'}, {english: 'moon', russian: 'луна'}, {
        ...
        russian: 'естественная катастрофа'
    }],
    ...
    verbs_for_a1: [{english: "improve", russian: "улучшать"}, {english: "want", russian: "хотеть"}, {
        ...
        english: "can't imagine life without",
        russian: "не может представить свою жизнь без"
        ...
        english: "go to a restaurant",
        russian: "пойти в ресторан"
