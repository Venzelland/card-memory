...
function updateCounters() {
    ...
    document.getElementById('remainingWords').textContent = currentLanguage === 'eng' ? `Оставшиеся слова: ${remainingWords}` : `Remaining words: ${remainingWords}`;
    document.getElementById('learnedWords').textContent = currentLanguage === 'eng' ? `Изученные слова: ${learnedWords}` : `Learned words: ${learnedWords}`;
}
